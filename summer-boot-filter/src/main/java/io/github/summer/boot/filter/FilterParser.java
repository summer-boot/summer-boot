...
public interface FilterParser {
     ...
     * @return name >= :parameterName AND name <= :parameterName, name > :parameterName AND name < :parameterName
     */
    @NotNull
     ...
     */
    @NotNull
    String parseRangeFrom(@NotNull RangeFilter filter);
     ...
     */
    @NotNull
    String parseRangeTo(@NotNull RangeFilter filter);
