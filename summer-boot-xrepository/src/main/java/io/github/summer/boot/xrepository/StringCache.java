...
public class StringCache {
    ...
    public String get(String key) {
        ...
        try {
            ...
            LOGGER.error("get failed, prefixedKey: {}, key: {}, throwable: ", prefixedKey, key, ex);
            return null;
        }
    }
    ...
    public boolean set(String key, String value, long timeout) {
        String prefixedKey = prefixedKey(key);
        if (prefixedKey == null) {
            LOGGER.error("set failed, prefixedKey must not be null, key: {}, value: {}, timeout: {}", key, value, timeout);
            return false;
        }

        if (prefixedKey.isEmpty()) {
            LOGGER.error("set failed, prefixedKey must not be empty, key: {}, value: {}, timeout: {}", key, value, timeout);
            return false;
        }
    ...
    public boolean delete(String key) {
        ...
        try {
            ...
            LOGGER.error("delete failed, prefixedKey: {}, key: {}, throwable: ", prefixedKey, key, ex);
            return false;
        }
